...
export const PaymentConfirm = ({
  ...
  return (
    <Modal
      ...
      lockScroll={true}
      className="max-w-[90vw] w-[640px]"
      contentClassName="p-4 border-2 border-foreground/10 rounded-2xl bg-gradient-to-b from-background-light to-background"
    ...
    >
      <div className="flex flex-col gap-6 w-full">
        ...
        <div className="bg-foreground/10 h-[2px]" />

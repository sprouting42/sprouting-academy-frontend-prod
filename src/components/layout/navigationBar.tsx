...
import { ButtonCart } from "../drawer/buttonCart";
...
const NAVBAR_HEIGHT_CLASS = "top-28";
const MOBILE_MENU_PADDING_TOP_CLASS = "pt-24";

const SCROLL_THRESHOLD = 100;
const SCROLL_TOP_THRESHOLD = 10;

const HAMBURGER_LINE_HEIGHT = "h-0.75";
const HAMBURGER_GAP = "gap-1";
  ...
  const handleScroll = useCallback(() => {
    if (!ticking.current) {
      window.requestAnimationFrame(() => {
        ...
        if (isOpen || currentScrollY < SCROLL_TOP_THRESHOLD) {
          setIsVisible(true);
        ...
        {/* <div className="flex gap-4 items-center justify-end lg:gap-8">
          ...
          <div className="lg:hidden relative">
            <motion.button
              ...
              className={cn(
                ...
                isOpen
                  ...
                  : `flex flex-col justify-center ${HAMBURGER_GAP}`,
              )}
            ...
            >
              <motion.span
                className={cn(
                  `${HAMBURGER_LINE_HEIGHT} bg-primary rounded-full block`,
                  isOpen &&
              ...
              >
                <motion.span
                  className={`w-6 ${HAMBURGER_LINE_HEIGHT} bg-primary rounded-full block`}
                ...
                />
                <motion.span
                  className={`w-6 ${HAMBURGER_LINE_HEIGHT} bg-primary rounded-full block absolute top-0 left-0`}
            ...
            {isOpen && (
              <>
                ...
                >
                  <div
                    className={cn(
                      "flex flex-col gap-16 px-4 overflow-y-auto",
                      MOBILE_MENU_PADDING_TOP_CLASS,
                    )}
                  >

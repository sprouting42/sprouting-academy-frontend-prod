          ...
          <div className="flex flex-col gap-8 items-start justify-between lg:flex-row lg:gap-8 lg:items-center w-full">
            <div className="flex flex-col gap-4 items-start lg:w-117 w-full">
              <div className="flex flex-row gap-3 items-center">
                ...
                />
                <h1 className="font-bold leading-6.75 text-lg text-primary">
            ...
            <div className="flex flex-col gap-8 items-start justify-center lg:flex-row lg:justify-start lg:w-auto w-full">
              {footerSections.map((section) => (
                <div
                  key={section.heading}
                  className="flex flex-col gap-4 items-start lg:min-w-52 w-full"
                >

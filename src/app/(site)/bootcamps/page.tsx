...
export default function BootcampsPage() {
  ...
  const popupImages = [
    { src: "/courses/ads bootcamp-01.jpg", alt: "Bootcamp Course" },
    { src: "/courses/ads bootcamp-02.jpg", alt: "Bootcamp Course" },
    { src: "/courses/ads bootcamp-03.jpg", alt: "Bootcamp Course" },
  ];

  ...
  return (
    <div>
      <div className="flex flex-col items-center justify-center w-full">
        <h1 className="bg-clip-text bg-gradient-to-r font-bold font-prompt from-secondary mt-56 px-28 text-[4rem] text-transparent to-primary">
      ...
      <div className="flex flex-row gap-8 mt-16 px-28">
        ...
        <div className="mb-[12.625rem] w-1/2">
          <PaymentCard
            cardTitle="ชำระเงิน"
            dropdownOptions={[
              "โอนเงินผ่านธนาคาร",
            ...
            onApplyDiscount={(code) => console.log("Coupon:", code)}
          />
        </div>
      </div>
    </div>

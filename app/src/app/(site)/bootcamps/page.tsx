...
import { whyUsData } from "@/data/ิbootcamp-whyuscard";
...
export default function BootcampsPage() {
  ...
  return (
    <div className="font-prompt">
      ...
      >
        <h1 className="bg-clip-text bg-linear-to-r font-bold from-secondary md:text-[4rem] text-[2rem] text-center text-transparent to-primary">
          เปลี่ยนเป็น Full Stack Developer ภายใน 6 เดือน
        </h1>
        <p className="font-normal mb-8 md:text-[1.375rem] mt-4 text-base text-center">
      ...
      <motion.h2
        ...
        className="[html[data-theme='dark']_&]:text-secondary font-bold mb-8 text-[1.75rem] text-center text-primary"
      >
        ทำไมต้องเรียนกับเรา?
      </motion.h2>
      <motion.div
      ...
      <motion.h2
        ...
        transition={{ duration: 0.5 }}
        className="[html[data-theme='dark']_&]:text-secondary font-bold mt-24 text-[1.75rem] text-center text-primary"
      >
        รายละเอียดคอร์ส
      </motion.h2>
      <motion.p

...
export const Input = ({
  ...
  const variantClasses = {
    primary:
      ...
      "placeholder:text-[#E5E8E880] border-0 focus:outline-none rounded-full bg-background " +
      (isDisabled
        ? "opacity-50 cursor-not-allowed"
        : "cursor-text hover:bg-background-light focus:bg-background-light transition-colors duration-200") +
      ...
      <div
        className={cn(
          "rounded-full p-px bg-linear-to-t from-foreground/50 to-background-light overflow-hidden relative flex items-center " +
            ...
            (isDisabled
              ? ""
              : "hover:from-foreground/60 hover:to-background-light focus-within:from-foreground/70 focus-within:to-background-light"),
          className,
        )}
      >
        {prefix && (

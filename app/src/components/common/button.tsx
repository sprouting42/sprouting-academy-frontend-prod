...
export const Button = ({
  ...
  const baseButtonClasses =
    "font-prompt flex items-center justify-center gap-2 transition-all duration-200 focus-visible:outline-none";

  const interactiveStates = "hover:opacity-90 active:opacity-80";
  ...
  > = {
    ...
    iconOnly: {
      inner: "bg-transparent hover:opacity-80 active:opacity-60",
    },
    linkButton: {
      inner: cn(
